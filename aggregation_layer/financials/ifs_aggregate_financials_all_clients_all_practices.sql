...
select
    coalesce(online_financials.finance_id, inclinic_financials.finance_id) as finance_id
...
inner join inclinic_financials on online_financials.finance_id = inclinic_financials.finance_id
